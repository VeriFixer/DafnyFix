...
public class IncrementMutator(string mutationTargetPos, string type, ErrorReporter reporter) 
        ...
        if (_chainingExpressionParent != null) {
            ...
            foreach (var (e, i) in operands.Select((e, i) => (e, i)).ToList()) {
                ...
                operands[i] = new BinaryExpr(originalExpr.Origin, 
                    BinaryExpr.Opcode.Add, nSegExpr, CreateOneLiteral(originalExpr.Origin));
            }
